...
export class IconSize {
    static inButton = 18;
    static inNavigate = 22;
}

// 모든 아이콘은 'https://svgomg.net'에 의해 한번씩 압축되어야 합니다.
export function Icon({name, size = 50, width = size, height = size, fill}: {
    name: string,
    width?: number,
    height?: number,
    size?: number,
    ...
    if (name == "user") {
        return fill
            ? <svg width={rWidth} height={rHeight} viewBox="0 0 50 50"><defs><clipPath id="a"><path d="M0 0h50v50H0z"/></clipPath></defs><g clip-path="url(#a)"><path d="M25.5 0A12.5 12.5 0 1 1 13 12.5 12.5 12.5 0 0 1 25.5 0ZM19 28h12a19 19 0 0 1 19 19v12a19 19 0 0 1-19 19H19A19 19 0 0 1 0 59V47a19 19 0 0 1 19-19Z"/></g></svg>
